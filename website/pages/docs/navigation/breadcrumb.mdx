...
Breadcrumb composes [Box](/docs-horizon-ui-dashboard/docs/layout/box) so you can
...
The BreadcrumbLink composes the [Link](/docs-horizon-ui-dashboard/link)
component so you can use all Link props.
...
[Box](/docs-horizon-ui-dashboard/docs/layout/box) component so you can use all
Box props.
