...
`MenuButton` composes [Box](/docs-purity-ui-dashboard/docs/layout/box) so you can pass all `Box` props to
change its style.

### MenuList Props

`MenuList` composes [Box](/docs-purity-ui-dashboard/docs/layout/box) so you can pass all `Box` props to
change its style.
...
`MenuGroup` composes [Box](/docs-purity-ui-dashboard/docs/layout/box) so you can pass all `Box` props to
change its style.
...
`MenuItemOption` composes [Box](/docs-purity-ui-dashboard/docs/layout/box) so you can pass all box props
