...
<Stack spacing={3}>
  ...
  <Input variant="flushed" placeholder="Flushed" borderRadius="16px" />
  <Input variant="unstyled" placeholder="Unstyled" borderRadius="16px" />
</Stack>
```
...
The `Input` component composes [Box](/docs-horizon-ui-dashboard/docs/layout/box)
so you can pass all `Box` props, and `React.InputHTMLAttributes`.
