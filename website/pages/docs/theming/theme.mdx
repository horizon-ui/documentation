...
description: The default Horizon UI Dashboard theme tokens
---

The theme object is where you define your Horizon UI Dashboard's color palette,
...
Horizon UI Dashboard comes with a predefined set of commonly used breakpoints.

> Learn more about
> [Responsive Styles and Customizing Breakpoints](/docs-horizon-ui-dashboard/docs/features/responsive-styles).
