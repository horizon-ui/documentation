...
> clickable icon, use the [IconButton](/docs-purity-ui-dashboard/docs/form/icon-button) instead.
...
[style props](/docs-purity-ui-dashboard/docs/features/style-props).
